...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='DFAN trainer.')
...
def main(args):
    ...
    if args.tensorboard and not args.is_testing:
        ...
        training_notes = ['DFAN, Xavier Normal Init, LR= ' + str(args.lr) + ' WD= '
